...
class FoodDetailsBottombar extends StatefulWidget {
  final int initialIndex;
  const FoodDetailsBottombar({super.key, this.initialIndex = 0});

  @override
  State<FoodDetailsBottombar> createState() => _FoodDetailsBottombarState();
}

class _FoodDetailsBottombarState extends State<FoodDetailsBottombar> {
