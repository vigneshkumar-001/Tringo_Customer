...
import '../../../Presentation/OnBoarding/Screens/Food Screen/food_booking_failed.dart';
...
class PaymentFailedBottombar extends StatefulWidget {
  final int initialIndex;
  const PaymentFailedBottombar({super.key, this.initialIndex = 0});

  @override
  State<PaymentFailedBottombar> createState() =>
      _PaymentFailedBottombarState();
}

class _PaymentFailedBottombarState
    extends State<PaymentFailedBottombar> {
