...
class ServiceDetailsData {
  ...
  factory ServiceDetailsData.fromJson(Map<String, dynamic> json) {
    return ServiceDetailsData(
      ...
      similarServices: SimilarServices.fromJson(json['similarServices'] ?? {}),
...
class Service {
  ...
  factory Service.fromJson(Map<String, dynamic> json) {
    return Service(
      ...
      // price -> startsAt (fall back to startsAt if backend changes later)
      startsAt:
