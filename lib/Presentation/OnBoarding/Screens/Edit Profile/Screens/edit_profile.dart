...
class _EditProfileState extends ConsumerState<EditProfile> {
  ...
  void initState() {
    ...
    nameController = TextEditingController(text: sanitize(widget.name));

    emailController = TextEditingController(text: sanitize(widget.email));

    genderController = TextEditingController(text: sanitize(widget.gender));

    mobileController = TextEditingController(
      text: _normalizeIndianPhone10(sanitize(widget.phone)),
    );

    dateOfBirthController = TextEditingController(
      text: normalizeDob(sanitize(widget.dob)),
    );
