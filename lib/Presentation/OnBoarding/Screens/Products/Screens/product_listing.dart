...
import 'package:tringo_app/Presentation/OnBoarding/Screens/Services%20Screen/Screens/Service_details.dart';
...
class _ProductListingState extends ConsumerState<ProductListing> {
  ...
  void initState() {
    super.initState();
    AppLogger.log.w('Iam In ${widget.kind}  ${widget.highlightId}');
                    ...
                    return CommonContainer.foodList(
                      ...
                      onTap: () {
                        if(widget.kind=='SERVICE'){
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                SearchServiceData(  serviceId: item.id),
                          ),
                        );
                        } else {
                         Navigator.push(
