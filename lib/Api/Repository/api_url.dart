class ApiUrl {
  ...
  static String ads({
    ...
    return "${base}api/v1/public/ads?lat=$lat&lng=$lang&placement=$placement";
  }

  static String nearbyShops({
    required String shopId,
    required double lat,
    required double lang,
  }) {
    return "${base}api/v1/public/shops/$shopId/nearby?lat=$lat&lng=$lang";
  }
